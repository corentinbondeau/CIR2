...
float get_area_rectangle_bis(const Shape_bis *shape_bis)
{
    const Shape *shape = (const Shape *)shape_bis;
    check_pointer_Shape(shape);
    return get_area_rectangle_base(shape);
}

float get_area_triangle_bis(const Shape_bis *shape_bis)
{
    const Shape *shape = (const Shape *)shape_bis;
    check_pointer_Shape(shape);
    return get_area_triangle_base(shape);
}

float get_area_circle_bis(const Shape_bis *shape_bis)
{
    const Shape *shape = (const Shape *)shape_bis;
    check_pointer_Shape(shape);
    return get_area_circle_base(shape);
}

float get_area_square_as_shape_bis(const Shape_bis *shape_bis)
{
    const Shape *shape = (const Shape *)shape_bis;
    check_pointer_Shape(shape);
    return get_area_square_as_shape_base(shape);
}
...
Shape_bis *create_rectangle_bis(float length, float width)
{
    ...
    shape->get_area = &get_area_rectangle_bis;
                               ...
                               float length_side3)
{
    ...
    shape->shape_data = (void *)data;
    shape->get_area = &get_area_triangle_bis;
...
Shape_bis *create_circle_bis(float radius)
{
    ...
    data->radius = radius;
    shape->shape_data = (void *)data;
    shape->get_area = &get_area_circle_bis;
...
Shape_bis *create_square_as_shape_bis(float length){
    ...
    data->length = length;
    shape->shape_data = (void *)data;
    shape->get_area = &get_area_square_as_shape_bis;
